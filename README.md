...
[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://fmcsaassistant.streamlit.app/)
...
```bash
git clone https://github.com/AlexandreAzevedo/fmcsa_assistant.git
cd fmcsa_assistant
```
